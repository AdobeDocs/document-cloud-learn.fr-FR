...
+ Prise en main {#get-started}
  ...
  + Travaillez plus intelligemment avec l’IA {#ai}
    ...
    + [Création d’un podcast](getting-started/podcast.md)
  + Créer et organiser {#create}
    ...
    + [Papier vers PDF](getting-started/scan-and-ocr.md)
  + Modifier et améliorer {#edit}
...
+ Série sur l’accessibilité {#accessibility-tutorials}
  ...
  + [Création d’un PDF accessible dans Acrobat](accessibility-series/accessible-acrobat.md)
  + [Principes de base du balisage](accessibility-series/basics-tagging.md)
  ...
  + [Listes complexes](accessibility-series/complex-lists.md)
  + [Tableaux complexes](accessibility-series/complex-tables.md)
...
+ Optimisé par l’IA {#ai-powered}
  ...
  + [Qu’est-ce qu’Acrobat Studio ?](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/basics/acrobat-studio)
  ...
  + [Création d’un podcast](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/ai/podcast)
...
+ Analyzer dans Acrobat Studio {#analyzer}
  ...
  + [Explorer les fonctionnalités avancées](analyzer/advanced.md)
  + Cas d’utilisation {#use-cases}
    ...
    + [Gestion de sous-traitance pour l&#39;identification de la détection des sources de marge d&#39;érosion](analyzer/use-cases/identify-margin-erosion.md)
  + [Webinaires](https://experienceleague.adobe.com/en/docs/events/acrobat-analyzer-webinars/overview){target=_blank}
+ Cas d’utilisation {#use-cases}
  ...
  + Secteur d’activité {#lob}
    ...
    + IT {#it}
      + [Présentation](use-cases/lob/it/it-overview.md)
      + [Activation informatique sans goulot d’étranglement](use-cases/lob/it/it-enablement.md)
    + Mentions légales {#legal}
      + [Présentation](use-cases/lob/legal/legal-overview.md)
      + [Transformer les informations juridiques en conseils pratiques](use-cases/lob/legal/legal-insights.md)
    + Marketing {#marketing}
      + [Présentation](use-cases/lob/marketing/marketing-overview.md)
      + [Accélérer le lancement des produits avec Acrobat Studio](use-cases/lob/marketing/marketing-product-launch.md)
    + Ventes {#sales}
      + [Présentation](use-cases/lob/sales/sales-overview.md)
      + [Transformez la veille client en atouts commerciaux gagnants](use-cases/lob/sales/sales-insights.md)
  + Administration {#gov}
