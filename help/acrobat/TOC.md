...
+ Prise en main {#get-started}
   ...
   + Forms, signatures et protection {#tools}
      ...
      + [Remplir et signer PDF forms](getting-started/fill-and-sign.md)
      + [Protection d’un fichier PDF avec un mot de passe](getting-started/password-protect.md)
      + [Obtenir les signatures](getting-started/signatures.md)
...
+ Série sur l’accessibilité {#accessibility-tutorials}
   ...
   + [L’intérêt et le pourquoi des fichiers PDF accessibles](accessibility-series/what-why-accessible-pdf.md)
   + [Configurer votre espace de travail](accessibility-series/set-up-workspace.md)
   + [Création d’un PDF accessible à partir de Word](accessibility-series/create-accessible-from-word.md)
...
+ Tâches avancées {#advanced-tasks}
   ...
   + Préparation et amélioration {#prepare}
      + [Compresser et optimiser un PDF](advanced-tasks/reduce.md)
      + [Optimiser des documents numérisés](advanced-tasks/optimizescan.md)
      + [Optimisation des PDF pour l’optimisation du moteur de recherche (SEO)](advanced-tasks/optimizeseo.md)
      + [Ajout de signets et de liens hypertexte](advanced-tasks/bookmarks.md)
...
+ Application mobile {#mobile}
   ...
   + [Productivité en déplacement](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/basics/productivity)
